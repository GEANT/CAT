...
distribution: all
	...
	rm -R -f build vendor phpcs.xml NewFolder nbproject .tx config/config-main.php config/config-confassistant.php config/config-diagnostics.php devices/Devices.php .codeclimate.yml .git .github .scrutinizer.yml .gitignore .gitmodules core/simpleSAMLphp core/PHPMailer core/PHPUnit core/GeoIP2
