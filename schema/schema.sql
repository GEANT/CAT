...
('general:instaltname','alternative name of the institution to be used in Disco search as keyword','string',NULL),
...
('fed:entitlement-attr', 'the entitlement value used by this federation for self-registration, will override the default geant:eduroam:inst:admin','string',NULL),
('fed:max-inactivity', 'custom number of days of allowed admin inactivity', 'integer', NULL),
('fed:hide-admin-warnings', 'do not show any warnings about missing/inactive admins', 'boolean', NULL),
