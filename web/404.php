...
echo $deco->defaultPagePrelude(\config\Main::APPEARANCE['productname_long'], FALSE);
?>
</head>
<body style='background: #fff url(resources/images/bg_grey_tile.png) repeat-x;'>
    <div id="heading">
        ...
        print '<div id="motd">' . ( isset(\config\Main::APPEARANCE['MOTD']) ? \config\Main::APPEARANCE['MOTD'] : '&nbsp' ) . '</div>';
        print '<h1 style="padding-bottom:0px; height:1em;">' . sprintf(_("Welcome to %s"), \config\Main::APPEARANCE['productname']) . '</h1>
<h2 style="padding-bottom:0px; height:0px; vertical-align:bottom;">' . \config\Main::APPEARANCE['productname_long'] . '</h2>';
