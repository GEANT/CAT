...
echo $deco->defaultPagePrelude(\config\Master::CONFIG['APPEARANCE']['productname_long'], FALSE);
?>
</head>
<body style='background: #fff url(resources/images/bg_grey_tile.png) repeat-x;'>
    <div id="heading">
        ...
        print '<div id="motd">' . ( isset(\config\Master::CONFIG['APPEARANCE']['MOTD']) ? \config\Master::CONFIG['APPEARANCE']['MOTD'] : '&nbsp' ) . '</div>';
        print '<h1 style="padding-bottom:0px; height:1em;">' . sprintf(_("Welcome to %s"), \config\Master::CONFIG['APPEARANCE']['productname']) . '</h1>
<h2 style="padding-bottom:0px; height:0px; vertical-align:bottom;">' . \config\Master::CONFIG['APPEARANCE']['productname_long'] . '</h2>';
