...
class Skinjob {
    ...
    public function __construct($selectedSkin = NULL) {
        ...
        $actualSkin = \config\Main::APPEARANCE['skins'][0];
        if (in_array($selectedSkin, \config\Main::APPEARANCE['skins'])) {
            $correctIndex = array_search($selectedSkin, \config\Main::APPEARANCE['skins']);
            $actualSkin = \config\Main::APPEARANCE['skins'][$correctIndex];
        }
