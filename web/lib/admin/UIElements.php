        ...
        foreach ($optionlist as $option) {
            ...
            if (preg_match('/^' . $class . '/', $option['name']) && $option['level'] == "$level") {
                ...
                if ($type["flag"] == "ML") {
                    ...
                    if ($option['lang'] != 'C') {
                        $language = \config\Main::LANGUAGES[$option['lang']]['display'] ?? "(unsupported language)";
                    }
                }
                ...
                switch ($type["type"]) {
                    ...
                    case "file":
                        ...
                        break;
                    case "boolean":
                        if ($option['name'] == "fed:silverbullet" && \config\Main::FUNCTIONALITY_LOCATIONS['CONFASSISTANT_SILVERBULLET'] == "LOCAL" && \config\Main::FUNCTIONALITY_LOCATIONS['CONFASSISTANT_RADIUS'] != "LOCAL") {
