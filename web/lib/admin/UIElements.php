...
class UIElements extends \core\common\Entity {
    ...
    public function displayName($input) {
        ...
        $displayNames = [_("Support: Web") => "support:url",
            ...
            _("OpenRoaming: Always") => "media:openroaming_always",
            _("OpenRoaming: User Choice") => "media:openroaming_ask",
            ...
            _("OpenRoaming: Custom NAPTR Target") => "fed_openroaming_customtarget",
            $ssidText => "media:SSID",
