...
class UserCredentialsForm implements PageElementInterface{
    ...
    public function __construct($distributor, $action, $title, $acknowledgeText, $isAcknowledgeEnabled = false) {
        ...
        $this->acknowledgeDays = isset(CONFIG_CONFASSISTANT['CONSORTIUM']['silverbullet_gracetime']) ? CONFIG_CONFASSISTANT['CONSORTIUM']['silverbullet_gracetime'] : SilverbulletUser::MAX_ACKNOWLEDGE;
