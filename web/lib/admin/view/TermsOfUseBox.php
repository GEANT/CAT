...
class TermsOfUseBox extends AbstractDialogBox{
    ...
    public function renderContent(){
        ...
        <p><?php echo \core\ProfileSilverbullet::PRODUCTNAME;?> outsources the technical setup of <?php echo CONFIG['CONSORTIUM']['name'] ." ".CONFIG['CONSORTIUM']['nomenclature_institution'];?> functions to the <?php echo CONFIG['CONSORTIUM']['name'];?> Operations Team. The system includes</p>
            <ul>
                ...
                <li>a technical infrastructure ("RADIUS") which verifies access credentials and subsequently grants access to <?php echo CONFIG['CONSORTIUM']['name'];?></li>
                <li><span style='color: red;'>TBD: a lookup/notification system which informs you of network abuse complaints by <?php echo CONFIG['CONSORTIUM']['name'];?> Service Providers that pertain to your users</span></li>
            </ul>
        <h2>User Account Liability</h2>
        <p>As an <?php echo CONFIG['CONSORTIUM']['name'] ." ".CONFIG['CONSORTIUM']['nomenclature_institution'];?> administrator using this system, you are authorized to create user accounts according to your local <?php echo CONFIG['CONSORTIUM']['nomenclature_institution'] ?> policy. You are fully responsible for the accounts you issue. In particular, you</p>
        <ul>
            <li>only issue accounts to members of your <?php echo CONFIG['CONSORTIUM']['nomenclature_institution'];?>, as defined by your local policy.</li>
            <li>must make sure that all accounts that you issue can be linked by you to actual human end users</li>
            <li>have to immediately revoke accounts of users when they leave or otherwise stop being a member of your <?php echo CONFIG['CONSORTIUM']['nomenclature_institution'];?></li>
            <li>will act upon notifications about possible network abuse by your users and will appropriately sanction them</li>
        </ul>
        <p>Failure to comply with these requirements may lead to the deletion of your <?php echo CONFIG['CONSORTIUM']['nomenclature_institution'];?> (and all the users you create inside) in this system.</p>
        <h2>Privacy</h2>
