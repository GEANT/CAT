...
switch ($inputDecoded['ACTION']) {
    ...
    case web\lib\admin\API::ACTION_NEWPROF_SB:
        try {
            $idp = $validator->existingIdP($adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_CAT_INST_ID), NULL, $fed);
        } catch (Exception $e) {
        ...
        if ($inputDecoded['ACTION'] == web\lib\admin\API::ACTION_NEWPROF_SB) {
            // auto-accept ToU?
            if ($adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_SB_TOU) !== FALSE) {
        ...
        $realm = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_PROFILE_REALM);
        $outer = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_PROFILE_OUTERVALUE);
        if ($realm !== FALSE) {
            if ($outer === FALSE) {
                $outer = "";
        ...
        $testuser = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_PROFILE_TESTUSER);
        if ($testuser !== FALSE) {
        ...
        $hint = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_PROFILE_INPUT_HINT);
        $enforce = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_PROFILE_INPUT_VERIFY);
        if ($enforce !== FALSE) {
    ...
    case web\lib\admin\API::ACTION_ENDUSER_CHANGEEXPIRY:
        ...
        $user = $validator->string($adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_SB_USERNAME));
        $expiryRaw = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_SB_EXPIRY);
        if ($expiryRaw === FALSE) {
    ...
    case \web\lib\admin\API::ACTION_TOKEN_NEW:
        ...
        list($idp, $profile) = $evaluation;
        $userId = $validator->integer($adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_SB_USERID));
        if ($userId === FALSE) {
        ...
        switch ($inputDecoded['ACTION']) { // this is where the two differ
            case \web\lib\admin\API::ACTION_ENDUSER_DEACTIVATE:
                ...
                break;
            case \web\lib\admin\API::ACTION_TOKEN_NEW:
                $counter = $validator->integer($adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_TOKEN_ACTIVATIONS));
                ...
                $emailRaw = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_TARGETMAIL);
                ...
                $smsRaw = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_TARGETSMS);
                if ($smsRaw !== FALSE) {
    ...
    case \web\lib\admin\API::ACTION_ENDUSER_IDENTIFY:
        ...
        list($idp, $profile) = $evaluation;
        $userId = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_SB_USERID);
        $userName = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_SB_USERNAME);
        $certSerial = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_SB_CERTSERIAL);
		$certCN = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_SB_CERTCN);
    ...
    case \web\lib\admin\API::ACTION_TOKEN_LIST:
        ...
        switch ($inputDecoded['ACTION']) {
            case \web\lib\admin\API::ACTION_ENDUSER_LIST:
                ...
                break;
            case \web\lib\admin\API::ACTION_TOKEN_LIST:
                $user = $validator->integer($adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_SB_USERID));
                if ($user !== FALSE) {
                    $allUsers = [$user];
                }
                $tokens = [];
    ...
    case \web\lib\admin\API::ACTION_CERT_REVOKE:
        ...
        $serialRaw = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_SB_CERTSERIAL);
        if ($serialRaw === FALSE) {
            exit(1);
        }
    ...
    case \web\lib\admin\API::ACTION_CERT_ANNOTATE:
        ...
        $annotationRaw = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_SB_CERTANNOTATION);
    ...
    case web\lib\admin\API::ACTION_STATISTICS_INST:
        $retArray = [];
        $idpIdentifier = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_CAT_INST_ID);
    ...
    case web\lib\admin\API::ACTION_DIAG_TESTS:
        ...
        $login_user = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_DIAG_USERNAME);
        $login_pass = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_DIAG_PASSWD);
        $login_outer = $adminApi->firstParameterInstanceOld($scrubbedParameters, web\lib\admin\API::AUXATTRIB_DIAG_OUTERUSER);
