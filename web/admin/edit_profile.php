    ...
    <fieldset class="option_container">
        ...
        if ($wizardStyle) {
            ...
            if (count(CONFIG_DIAGNOSTICS['RADIUSTESTS']['UDP-hosts']) > 0 || CONFIG_DIAGNOSTICS['RADIUSTESTS']['TLS-discoverytag'] != "") {
                printf(_("This is useful if you want to use the sanity check module later, which tests reachability of your realm in the %s infrastructure. "), CONFIG_CONFASSISTANT['CONSORTIUM']['name']);
            }
