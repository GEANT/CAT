    ...
    switch ($_POST['submitbutton']) {
        ...
        case web\lib\common\FormElements::BUTTON_TAKECONTROL:
            if ($isFedAdmin) {
                ...
                echo "Fatal Error: you wanted to take control over an " . \config\ConfAssistant::CONFIG['CONSORTIUM']['nomenclature_institution'] . ", but are not a " . \config\ConfAssistant::CONFIG['CONSORTIUM']['nomenclature_federation'] . " operator!";
                exit(1);
            }
            break;
        default:
