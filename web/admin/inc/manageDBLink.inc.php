...
if ((isset($_POST['submitbutton']) && $_POST['submitbutton'] == web\lib\common\FormElements::BUTTON_CLOSE ) || \config\Master::CONFIG['DB']['enforce-external-sync'] == FALSE) {
        ...
        case \core\IdP::EXTERNAL_DB_SYNCSTATE_SYNCED:
            ...
            foreach ($names as $name) {
                if ($name['lang'] == "C") {
                    ...
                    $language = \config\Master::CONFIG['LANGUAGES'][$name['lang']]['display'] ?? "(unsupported language)";
                }
