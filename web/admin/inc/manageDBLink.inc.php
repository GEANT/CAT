...
if (!$isFedAdmin) {
    echo sprintf(_("You do not have the necessary privileges to manage the %s DB link state of this %s."), CONFIG_CONFASSISTANT['CONSORTIUM']['display_name'], $uiElements->nomenclatureInst);
    exit(1);
}
