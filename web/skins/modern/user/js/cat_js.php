...
$(".signin").DiscoJuice({
   ...
   "textHelpMore": "<?php escaped_echo(sprintf(_("This system relies on information supplied by local %s administrators. If your organisation is not on the list, then nag them to add information to the %s database."), \config\ConfAssistant::CONFIG['CONSORTIUM']['display_name'], \config\Master::CONFIG['APPEARANCE']['productname'])); ?>",
