...
<div class='footer' id='footer'>
    <table>
        ...
        if (!empty(\config\Master::APPEARANCE['privacy_notice_url'])) {
              $retval .= "<td>".$this->Gui->catCopyrightAndLicense."<br><span id='privacy_notice_cons'>".\config\ConfAssistant::CONSORTIUM['display_name']."</span> <a href='".\config\Master::APPEARANCE['privacy_notice_url']."'>".sprintf(_("%s Privacy Notice"), '')."</a></td>";
        }
        $retval .= "<td>";
