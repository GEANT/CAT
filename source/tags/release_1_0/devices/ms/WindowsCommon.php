...
protected function signInstaller($attr) {
   ...
   $e = Config::$CONSORTIUM['name'].'_'.$this->device_id.'_'.preg_replace('/ +/','_',iconv("UTF-8", "US-ASCII//IGNORE",$attr['general:instname'][0])).'.exe';
   if($this->sign) {
      $o = system($this->sign." installer.exe $e > /dev/null");
      debug(4,"signInstaller:$o\n");
   }
   else
...
'no'=>array('nsis'=>"Norwegian",'cp'=>'1252'),
