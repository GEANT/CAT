 ...
 *
 * - sign - if set to nonzero will cause installer signing if the module supports this
 ...
 *
 * Except for changing/adding things inside the options arrays, do not modify this array unless you really konw what you are doing.
 *
 ...
 * - 'signer' if defined points to a script which will sign a file. The scropt must be licated in the signer
 *    subdirectory of CAT .The first argument of this script must be the input file name, 
 *    the second - the signed file filename. Signer will not be used unless the sign option is set to nonzero.
 *
