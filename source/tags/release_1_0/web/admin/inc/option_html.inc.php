...
// attribute content
        ...
        switch ($listtype["type"]) {
            ...
            case "file":
                ...
                break;
            case "string":
                $retval .= "<strong>$content</strong><input type='hidden' name='value[S$rowid-0]' id='S" . $rowid . "-input-string' value='$content' style='display:block'>";
                break;
            case "text":
                $retval .= "<strong>$content</strong><input type='hidden' name='value[S$rowid-1]' id='S" . $rowid . "-input-text' value='$content' style='display:block'>";
                break;
            case "boolean":
                if ($content == "on")
