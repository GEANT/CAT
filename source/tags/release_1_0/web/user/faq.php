...
array_push($FAQ,
      array(
        ...
        'text'=>sprintf(_("%s installers configure your security therefore you should be sure that you are using genuine ones. This is why %s installers are digitally signed by TERENA. Watch out for a system message confirming this."),Config::$APPEARANCE['productname'],Config::$APPEARANCE['productname'])
));
