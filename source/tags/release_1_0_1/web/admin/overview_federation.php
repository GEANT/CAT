...
<body>
    ...
    <table class='user_overview' style='border:0px;'>
        ...
        foreach ($feds as $onefed) {
            ...
            echo "<tr><td colspan='3'><strong>" . sprintf(_("Your federation %s contains the following institutions:"), '<span style="color:green">' . $thefed::$FederationList[$onefed['value']] . '</span>') . "</strong></td></tr>";
    ...
    <hr/>
    <br/>
    <form method='post' action='inc/manageNewInst.inc.php' onsubmit='popupRedirectWindow(this); return false;'>
