...
class Device_mobileconfig extends DeviceConfig {
    ...
    public function writeInstaller() {
        ...
        $this->massaged_inst       = strtolower(iconv("UTF-8", "US-ASCII//IGNORE", preg_replace(array('/ /','/\//'), '_', $this->attributes['general:instname'][0])));
        $this->massaged_profile    = strtolower(iconv("UTF-8", "US-ASCII//IGNORE", preg_replace(array('/ /','/\//'), '_', $this->attributes['profile:name'][0])));
        $this->massaged_country    = strtolower(iconv("UTF-8", "US-ASCII//IGNORE", preg_replace(array('/ /','/\//'), '_', $this->attributes['internal:country'][0])));
        $this->massaged_consortium = strtolower(iconv("UTF-8", "US-ASCII//IGNORE", preg_replace(array('/ /','/\//'), '_', Config::$CONSORTIUM['name'])));
...
<plist version=\"1.0\">
   <dict>
      ...
      <key>ConsentText</key>
         <dict>
            <key>default</key>
               <string>" . iconv("UTF-8", "UTF-8//IGNORE",$this->attributes['support:info_file'][0]) . "</string>
         </dict>
         ");
        fwrite($xml_f, "</dict>
</plist>");
