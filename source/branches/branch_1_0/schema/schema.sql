...
CREATE TABLE `eap_method` (
  `eap_method_id` int(11) NOT NULL AUTO_INCREMENT,
  `display_name` varchar(255) NOT NULL DEFAULT '',
  `php_serialized` varchar(256) NOT NULL DEFAULT '',
  PRIMARY KEY (`eap_method_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `eap_method` VALUES 
  (1,'TTLS-PAP','a:2:{s:5:\"OUTER\";i:21;s:5:\"INNER\";i:0;}'),
  (2,'PEAP-MSCHAPv2','a:2:{s:5:\"OUTER\";i:25;s:5:\"INNER\";i:26;}'),
  (3,'TLS','a:2:{s:5:\"OUTER\";i:13;s:5:\"INNER\";i:0;}'),
  (4,'FAST-GTC','a:2:{s:5:\"OUTER\";i:43;s:5:\"INNER\";i:6;}'),
  (5,'TTLS-GTC','a:2:{s:5:\"OUTER\";i:21;s:5:\"INNER\";i:6;}'),
  (6,'TTLS-MSCHAPv2','a:2:{s:5:\"OUTER\";i:21;s:5:\"INNER\";i:26;}'),
  (7,'EAP-pwd','a:2:{s:5:"OUTER";i:52;s:5:"INNER";i:0;}');
...
('general:SSID','additional SSID to configure, WPA2/AES only','string',NULL),
('general:SSID_with_legacy','additional SSID to configure, WPA2/AES and WPA/TKIP','string',NULL),
...
('profile:QR-user','PNG file with the QR tag for the user download target','file', NULL),
