...
<?php if(! isset($_REQUEST['idp']) || ! $_REQUEST['idp']) { ?>
                <table id="front_page">
                    <tr>
                        <td id="front_page_leftmenu" rowspan=2>
                                ...
                                <tr>
                                    <td id="slides" style="background: #fff url(resources/images/gradient-bg.png) repeat-x; height:272px; border-radius: 16px; width: 100%; padding-left:20px;">
                                        <div>
                                            ...
                                            <span id="line2"></span> <!-- DEVICE GROUP -->
                                            <span id="line3"></span> <!-- DEVICE NAME -->
                                            <span id="line4">        <?php echo _("Custom built for your home institution") ?></span>
                                            <span id="line5">        <!-- SIGNED or EMPTY-->
                                            <?php
                                        ...
                                        <img class="rolling_image" id="img_roll_0" src="resources/images/empty.png" alt="Rollover 0"/> <img class="rolling_image" id="img_roll_1" src="resources/images/empty.png" alt="Rollover 1"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
