...
class Messages:
    ...
    cont = "Continue?"
    nm_not_supported ="This Network Manager version is not supported"
    ...
    save_wpa_conf = "Network Manager configuration failed, but we may generate a wpa_supplicant configuration file if you wish. Be warned that your connection password will be saved in this file as clear text."
