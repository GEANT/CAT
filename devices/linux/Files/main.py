...
class Messages:
    ...
    save_wpa_conf = "NetworkManager configuration failed, but we may " \
                    "generate a wpa_supplicant configuration file if you " \
                    "wish. Be warned that your connection password will be " \
                    "saved in this file as clear text."
    ...
    wrong_realm_suffix = "Error: your username must be in the form of " \
                         "'xxx@institutionID' and end with '{}'. Please " \
...
class CatNMConfigTool:
    def connect_to_NM(self):
        ...
        if self.nm_version == "0.9" or self.nm_version == "1.0":
            ...
            self.connection_interface_name = "org.freedesktop.Networ" \
                                             "kManager.Settings.Connection"
            # settings proxy
            ...
            self.connection_interface_name = "org.freedesktop.Network" \
                                             "ManagerSettings.Connection"
            # settings proxy
            sysproxy = self.bus.get_object(self.settings_service_name,
    ...
    def delete_existing_connections(self, ssid):
        ...
        for each in conns:
            ...
            connection = dbus.Interface(con_proxy, "org.freedesktop.Network"
                                                   "Manager.Settings."
                                                   "Connection")
            try:
    ...
    def add_connection(self, ssid, user_data):
        ...
        s_8021x_data = {
            ...
            'ca-cert': dbus.ByteArray("file://{0}\0"
                                      "".format(self.cacert_file
                                                ).encode('utf8')),
