...
%s"), common\Entity::$nomenclature_inst, $this->name, \config\ConfAssistant::CONSORTIUM['display_name'], strtoupper($fed->name), \config\Main::APPEARANCE['productname'], \config\Main::APPEARANCE['productname_long']);
