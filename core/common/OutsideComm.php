...
";
        ...
        if ($federation !== NULL) { // see if we are supposed to add a custom message
...
" . ( /* $new_idp_authorized_fedadmin */ FALSE ?
                wordwrap(sprintf(_("manually. If you reply to this mail, you will reach your %s administrators."), $cat->nomenclature_fed), 72) :
