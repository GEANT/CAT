...
class CAT extends \core\common\Entity 
{
    ...
    public function __construct() {
        ...
        $product = \config\Main::APPEARANCE['productname'];
    ...
    public static function getRootUrlPath() {
        return substr(\config\Main::PATHS['cat_base_url'], -1) === '/' ? substr(\config\Main::PATHS['cat_base_url'], 0, -1) : \config\Main::PATHS['cat_base_url'];
    }
